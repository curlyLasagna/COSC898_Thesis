...
\usepackage{pdfpages}
\usepackage{fontspec}
\newfontfamily\zedmono{ZedMono Nerd Font}[Scale=MatchLowercase]
\usepackage{listings}
\makeatletter
% Ensure newlines are emitted at start of line before any multibyte Unicode characters,
% and allow listings to wrap lines (TUgrad.cls sets \exhyphenpenalty=10000 which prevents wrapping)
\lst@AddToHook{InitVarsBOL}{\lst@TrackNewLines\exhyphenpenalty=50\hyphenpenalty=50}
\makeatother
\lstset{
  basicstyle=\zedmono\small\linespread{1}\selectfont,
...
% -------------------------------------------------------------------------
%% Part 1 - Introduction
\input{Pages/B-Text/intro}
% -------------------------------------------------------------------------
%% Part 2 - Literature Review
\input{Pages/B-Text/litreview}
% -------------------------------------------------------------------------
%% Part 3 - Main Works
% -----Main work 1
\input{Pages/B-Text/body}
% -------------------------------------------------------------------------
% Part 4 - Conclusion
\input{Pages/B-Text/conclusion}
% -------------------------------------------------------------------------
